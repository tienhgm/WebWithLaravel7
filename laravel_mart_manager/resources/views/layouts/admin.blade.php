...
<body>
    <div id="warpper" class="nav-fixed">
        <nav class="topnav shadow navbar-light bg-white d-flex">
            <div class="navbar-brand"><a href="?">ADMIN TIEN_VNU</a></div>
            <div class="nav-right ">
        ...
        <div id="page-body" class="d-flex">
            <div id="sidebar" class="bg-white">
                <ul id="sidebar-menu">
                    ...
                    <li class="nav-link {{$module_active=='category_post' ? 'active': '' }}">
                        <a href="{{url('admin/post/category/list')}}">
                            <div class="nav-link-icon d-inline-flex">
                                <i class="far fa-folder"></i>
                            </div>
                            Danh mục bài viết
                        ...
                        <i class="arrow fas fa-angle-right"></i>
                        <ul class="sub-menu">
                            <li><a href="{{url('admin/post/category/add')}}">Thêm mới</a></li>
                    ...
                    <li class="nav-link {{$module_active=='category_product' ? 'active': '' }}">
                        ...
                        <i class="arrow fas fa-angle-right"></i>
                        <ul class="sub-menu">
                            <li><a href="{{url('admin/product/category/add')}}">Thêm mới</a></li>
                    ...
                    <li class="nav-link {{$module_active=='order' ? 'active': '' }}">
                        ...
                        <i class="{{url('admin/order/list')}}"></i>
                        <ul class="sub-menu">
